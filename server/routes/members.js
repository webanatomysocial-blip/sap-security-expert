...
const { requireAdmin, requireMemberAuth, requireCsrf } = require('../middleware/auth');
...
router.get('/profile', requireMemberAuth, controller.getProfile);
router.post('/profile/update', requireMemberAuth, (req, res, next) => {
